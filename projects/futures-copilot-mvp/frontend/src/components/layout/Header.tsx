      ...
      <div className="flex justify-between items-center px-4 md:px-8 py-4">
        ...
        <div className="flex items-center gap-6">
          {session ? (
            ...
            <button 
              onClick={() => setSession({ user: { name: 'YZ', role: 'ADMIN' } })}
              className="font-mono text-xs uppercase tracking-widest bg-black text-white dark:bg-white dark:text-black px-4 py-2 hover:opacity-80 transition-opacity flex items-center gap-2"
            >
          ...
          {mounted && (
            <button 
              ...
              className="font-mono text-xs uppercase tracking-widest hover:opacity-50 transition-opacity ml-2"
              title="Toggle Theme"
            >
