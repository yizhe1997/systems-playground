    ...
    <div className="w-full relative">
      <main className="max-w-[800px] mx-auto relative px-4 md:px-8 py-12 lg:py-24">
          ...
          <div className={`relative bg-white dark:bg-black h-full ${PANEL_CHAMFER} p-6 md:p-10`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <button
                type="submit"
                disabled={!canSubmit}
                className="fc-btn w-full md:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 text-[10px] disabled:opacity-40"
              >
        ...
        <div className="mt-32 pt-16 border-t border-black dark:border-white text-center">
          ...
          <Link href="/alerts" className="fc-btn inline-flex px-8 py-4 text-[10px]">
            CONFIGURE ALERTS
          </Link>
        </div>
