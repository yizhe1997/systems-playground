                ...
                <div className="p-6 border-t border-black dark:border-white bg-[#f8f8f8] dark:bg-[#111] text-center">
                  {userRole === 'ANON' ? (
                    ...
                    <>
                      ...
                      <Link href="/alerts" className="px-6 py-3 border border-black dark:border-white font-mono text-xs uppercase tracking-widest font-bold hover:opacity-50 transition-opacity inline-flex items-center gap-2">
