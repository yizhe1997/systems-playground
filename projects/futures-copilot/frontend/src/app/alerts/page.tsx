          ...
          <div className={`relative bg-white dark:bg-black h-full flex flex-col ${PANEL_CHAMFER} p-8 md:p-12`}>
            ...
            <div ref={dropdownRef} className="relative mb-10 self-start min-w-[220px]">
              ...
              <button
                ...
                className="fc-card w-full px-4 py-3 font-mono text-sm uppercase tracking-widest focus:outline-none flex justify-between items-center gap-6 text-black dark:text-white"
              >
            ...
            <div className="space-y-8">
              <div>
                ...
                <input
                  ...
                  className="fc-input-line py-3 text-lg focus:border-amber-500 placeholder:opacity-30"
                />
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <button
                  ...
                  className="fc-btn flex-1 py-4 flex justify-center items-center gap-2 disabled:opacity-40"
                >
            ...
            {status === 'loading' ? (
              ...
              <div className={`absolute inset-0 z-20 bg-white/60 dark:bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center p-8 text-center ${PANEL_CHAMFER}`}>
                <div className="fc-card p-8 max-w-sm shadow-2xl">
                  <>
                    ...
                    <button
                      ...
                      className="fc-btn w-full py-4 inline-flex items-center justify-center gap-3 leading-none disabled:opacity-40"
                    >
