...
const MOCK_COLLABORATORS = [
  { id: 'usr_1', email: 'alice@example.com', status: 'ACTIVE', role: 'RESEARCHER', joined: 'Apr 01, 2026' },
  { id: 'usr_2', email: 'bob@example.com', status: 'INACTIVE', role: 'OBSERVER', joined: 'Mar 15, 2026' },
  { id: 'usr_3', email: 'charlie@example.com', status: 'ACTIVE', role: 'RESEARCHER', joined: 'Apr 10, 2026' },
];
        ...
        <div className="mb-16 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-mono text-xs uppercase tracking-widest opacity-60">
              Manage research access and collaborator permissions.
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-left font-mono text-xs uppercase tracking-widest">
            <thead>
              <tr className="border-b border-black dark:border-white">
                ...
                <th className="py-4 opacity-60 font-normal">ROLE</th>
