...
- **Scale-to-zero:** heavy containers (RabbitMQ, Redpanda) are started/stopped on demand by the Go control plane's reaper after a period of inactivity — required because the production host is a resource-constrained NUC. See ADR 001.
