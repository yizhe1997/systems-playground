...
LOGFILE="/home/yizhe/apps/wsl-startup-logs/wsl-startup.log"
...
# Navigate to the n8n directory and start all services from docker compose
echo "[*] Starting docker compose services..."
cd /home/yizhe/apps/n8n/ || exit 1
docker compose pull && docker compose up --build -d
sleep 5

# Navigate to the aspire directory and start all services from docker compose
echo "[*] Starting aspire services..."
cd /home/yizhe/apps/aspire || exit 1
